...
protected:
  ...
  virtual double
  computeResiduals (const SE3<double>& model, bool linearize_system, bool compute_weight_scale = false);
...
public:
  ...
  void
  runOptimization(SE3<double>& model, int levelBegin = -1, int levelEnd = -1);
